import {
  ...
  navigateToAgents,
  buildInitScript,
} from "./fixtures/browser-acp-mock";
...
test.describe("Agents view", () => {
  ...
  test("displays agent cards from mock data", async ({
    browserMocked: page,
  }) => {
    await navigateToAgents(page);
  ...
  test("shows create new agent button", async ({ browserMocked: page }) => {
    await navigateToAgents(page);
  ...
  test("Delete triggers confirmation dialog", async ({
    browserMocked: page,
  }) => {
    await navigateToAgents(page);
  ...
  test("search filters agents", async ({ browserMocked: page }) => {
    await navigateToAgents(page);
