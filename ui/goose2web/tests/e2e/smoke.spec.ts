import { expect, test } from "./fixtures/browser-acp-mock";

test.describe("Smoke tests", () => {
  test("app loads and shows home screen", async ({ browserMocked: page }) => {
    await page.goto("/");
  ...
  test("home screen shows clock", async ({ browserMocked: page }) => {
    await page.goto("/");
